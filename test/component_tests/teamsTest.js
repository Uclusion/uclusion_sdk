...
app.post('/realmadrid/bind', (request, response) => {
  response.json({ success_message: 'Team bound' });
});

app.post('/bind', (request, response) => {
  response.json({ success_message: 'Team bound' });
});
...
describe('Teams', () => {
  ...
  describe('#doBind', () => {
    it('should bind team without error', () => {
      let promise = teams.bind('realmadrid');
      promise.then((result) => {
        //console.log(result);
  ...
  describe('#doBindAnonymous', () => {
    it('should bind anonymous team without error', () => {
      let promise = teams.bindAnonymous();
      promise.then((result) => {
        //console.log(result);
        assert(result.success_message === 'Team bound');
      }).catch((error) => {
  ...
  describe('#doListRoi', () => {
    it('should get the Roi without error', () => {
      let promise = teams.listRoi('teamwithroi', 'aresolutionid');
      promise.then((result) => {
